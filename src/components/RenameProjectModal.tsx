...
export const RenameProjectModal: React.FC<RenameProjectModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 dark:bg-black/60 backdrop-blur-sm p-4 animate-in fade-in duration-200">
      <div
        className="bg-white/90 dark:bg-white/10 backdrop-blur-xl border border-white/20 text-slate-800 dark:text-white w-full max-w-md rounded-2xl shadow-2xl flex flex-col overflow-hidden transform transition-all scale-100 animate-in zoom-in-95 duration-200"
        ...
        <form onSubmit={handleSubmit} className="p-6 flex flex-col gap-6">
          ...
          <div className="flex justify-end gap-3 pt-2">
            ...
            <button
              ...
              className="flex items-center justify-center px-5 py-2.5 bg-blue-600 hover:bg-blue-700 text-white text-sm font-medium rounded-xl transition-all shadow-sm hover:shadow-md disabled:opacity-50 disabled:cursor-not-allowed min-w-[100px]"
            >
              {isLoading ? (
